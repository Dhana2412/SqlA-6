...
namespace A_6
{
    internal class Program
    {
        ...
        static string conStr = "server=LAPTOP-JL3U744Q; database=ProdcutInventoryDB; trusted_connection=true;";
        ...
        static void InsertProduct()
        {
            ...
            cmd = new SqlCommand("INSERT INTO Product(ProductId,ProductName, Price, Quantity, MfDate, ExpDate) VALUES (@ProductId,@ProductName, @Price, @Quantity, @MfDate, @ExpDate)", con);
        ...
        static void UpdateProduct()
        {
            ...
            cmd = new SqlCommand("UPDATE Product SET ProductName = @NewProductName, Price = @NewPrice, Quantity = @NewQuantity, MfDate = @NewMfDate, ExpDate = @NewExpDate WHERE ProductId = @ProductId", con);
